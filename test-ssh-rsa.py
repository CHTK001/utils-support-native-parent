"""
Use RSA PEM key (JSCH 0.1.55 supports RSA PEM)
"""
import asyncio
from playwright.async_api import async_playwright
EDGE = r'C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe'

with open(r'D:\ch\project\test_id_rsa', 'r') as f:
    KEY = f.read()
...
async def main():
    async with async_playwright() as pw:
        ...
        await page.wait_for_timeout(20000)  # wait for SSH + WS
        ...
        await page.screenshot(path=r'D:\ch\project\e2e-results\step-ssh-final.png', full_page=True)
        await browser.close()
asyncio.run(main())
