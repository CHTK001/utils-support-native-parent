...
body = json.dumps({"Cmd": ["sh", "-c", "find / -name '*.db' -path '*gateway*' 2>/dev/null; find / -name '*.sqlite*' 2>/dev/null | head -5; ls /app/dependencies/ | grep -i sql"]}).encode()
...
print("no p.log file was written")
